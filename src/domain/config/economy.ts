 ...
 *
 * **Источники расходятся, решение исполнителя, статус у владельца — открыт.**
 ...
 *
 * Это решение, а не заглушка. Вопрос владельцу записан в реестр
 * [[spec-prototype-build]] раздел 8, пункт 8: какой из двух документов правит
 * премию. До ответа число менять нельзя ни в ту, ни в другую сторону.
 */
